...
<style scoped>
.top{display:flex;gap:22rpx}.cover{width:220rpx;height:310rpx;border-radius:24rpx;background:#e5e7eb;flex-shrink:0}.info{flex:1;min-width:0}.book-title{display:block;font-size:40rpx;font-weight:900;color:#111827;line-height:1.35;margin-bottom:10rpx}.rating{display:block;color:#f97316;font-size:25rpx;font-weight:900;margin:12rpx 0}.actions{display:flex;gap:12rpx;margin-bottom:22rpx}.actions .btn{flex:1;font-size:25rpx;padding:0 10rpx}.desc{display:block;color:#475467;font-size:27rpx;line-height:1.8}.purchase{display:flex;justify-content:space-between;align-items:center;padding:18rpx 0;border-bottom:1rpx solid #eef2f7}.purchase-name{font-weight:900;color:#111827;font-size:28rpx}.comment{padding:18rpx 0;border-bottom:1rpx solid #eef2f7}.comment-user{font-weight:900;color:#111827}.comment-text{display:block;color:#475467;font-size:26rpx;line-height:1.65;margin:12rpx 0}.like{font-size:24rpx;color:#7c3aed;font-weight:900}
</style>
